...
const FLAG_MAP = {
  // Americas
  ARG:"🇦🇷", BRA:"🇧🇷", USA:"🇺🇸", MEX:"🇲🇽", CAN:"🇨🇦", COL:"🇨🇴",
  URU:"🇺🇾", ECU:"🇪🇨", VEN:"🇻🇪", PAR:"🇵🇾", CRC:"🇨🇷", PAN:"🇵🇦",
  HON:"🇭🇳", HAI:"🇭🇹", CUW:"🇨🇼",
  // Europe
  FRA:"🇫🇷", ENG:"🏴󠁧󠁢󠁥󠁮󠁧󠁿", ESP:"🇪🇸", GER:"🇩🇪", POR:"🇵🇹", NED:"🇳🇱",
  BEL:"🇧🇪", CRO:"🇭🇷", SUI:"🇨🇭", DEN:"🇩🇰", SWE:"🇸🇪", SRB:"🇷🇸",
  AUT:"🇦🇹", NOR:"🇳🇴", SCO:"🏴󠁧󠁢󠁳󠁣󠁴󠁿", TUR:"🇹🇷", UKR:"🇺🇦", SVK:"🇸🇰",
  CZE:"🇨🇿", BIH:"🇧🇦",
  // Africa
  MAR:"🇲🇦", SEN:"🇸🇳", NGA:"🇳🇬", EGY:"🇪🇬", CIV:"🇨🇮", GHA:"🇬🇭",
  TUN:"🇹🇳", ALG:"🇩🇿", RSA:"🇿🇦", COD:"🇨🇩", CPV:"🇨🇻",
  // Asia & Middle East
  JPN:"🇯🇵", KOR:"🇰🇷", KSA:"🇸🇦", IRN:"🇮🇷", AUS:"🇦🇺", QAT:"🇶🇦",
  IRQ:"🇮🇶", JOR:"🇯🇴", UZB:"🇺🇿",
  // Other
  NZL:"🇳🇿",
};
